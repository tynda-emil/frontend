...
data.albums.forEach((album) => {
  ...
  // Обновление обложки с обработкой ошибки загрузки
  const albumImage = albumElement.querySelector(".album-image");
  albumImage.onerror = () => {
    console.warn(`Ошибка загрузки изображения для альбома ${album.id}`);
    albumImage.src = "../images/frogs.gif"; // Устанавливаем резервное изображение
  };
